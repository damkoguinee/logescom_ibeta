    ...
    <table class="payement" style="width: 90%;">
      ...
      <thead>
        ...
        <tr>
          ...
          <form method="GET"  action="bulletin.php?transitaire">
            ...
            <th colspan="<?=$colspan;?>" height="30">Compte Transitaire <a style="margin-left: 10px;"href="printcomptecategorie.php?comptetransitaire" target="_blank"><img  style="height: 20px; width: 20px;" src="css/img/pdf.jpg"></a></th>
          </form>
        </tr>
        ...
        foreach ($prodclient as $key => $value){?>
          ...
          <tr>
            ...
            foreach ($panier->monnaie as $valuem) {        
              ...
              <td style="text-align: right; padding-right: 5px; color: white; font-size: 20px; background-color: <?=$color;?>"><a style="color:white;" href="bilantransitaire.php?bclient=<?=$products['nom_client'];?>&devise=<?=$devise;?>&frais"><?= number_format($montant,0,',',' '); ?></a></td><?php 
            }?>

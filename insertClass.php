...
class InsertInto{
    ...
    public function insertBulletin($nom_client,$libelles,$numero,$montant,$devise,$caissebul,$lieuvente,$date_versement){
        $this->DB->insert("INSERT INTO bulletin(nom_client,libelles,numero,montant,devise,caissebul,lieuvente,date_versement,origine_bull)Values(?,?,?,?,?,?,?,?,?)", array($nom_client,$libelles,$numero,$montant,$devise,$caissebul,$lieuvente,$date_versement,'vente facture'));

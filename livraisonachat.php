                ...
                <tr>
                  <th colspan="6">
                    <div class="d-flex justify-content-between">
                      <form class="form" method="POST" action="livraisonachat.php"><?php
                        if (isset($_POST['j1'])) {?>

                          <input class="form-control" id="reccode" style=" font-size: 14px;" type = "date" name = "j1" onchange="this.form.submit()" value="<?=$_POST['j1'];?>"><?php

                        }else{?>

                          <input class="form-control" id="reccode" style=" font-size: 14px;" type = "date" name = "j1" onchange="this.form.submit()"><?php
                      ...
                      <form method="POST" action="livraisonachat.php"><?php

                        if (isset($_POST['numcmd'])) {?>

                          <input class="form-control" style=" font-size: 18px;" type = "text" name = "numcmd" value="<?=$_POST['numcmd'];?>" onchange="this.form.submit()"><?php

                        }else{?>

                          <input class="form-control" style=" font-size: 18px;" type = "text" name = "numcmd" placeholder="rechercher par N°" onchange="this.form.submit()"><?php
              ...
              <tbody><?php 
                ...
                foreach ($products as $key=> $product ){
                  ...
                  <tr>
                    ...
                    <td><a class="btn btn-success" href="livraison.php?livraison=<?=$product->num_cmd;?>">Livraiosn</a></td>
                  </tr><?php 
                }?>
                    ...
                    <div class="d-flex justify-content-between">
                      <form method="POST" action="livraisonachat.php"><?php
                        if (isset($_POST['j1'])) {?>
                          ...
                          <input class="form-control" id="reccode" style=" font-size: 14px;" type = "date" name = "j2" onchange="this.form.submit()" value="<?=$_POST['j2'];?>"><?php

                        }else{?>

                          <input class="form-control" id="reccode" style=" font-size: 14px;" type = "date" name = "j2" onchange="this.form.submit()"><?php
                      ...
                      <form method="POST" action="livraisonachat.php"><?php
                        ...
                        if (isset($_POST['numcmd'])) {?>
                          ...
                          <input class="form-control" style=" font-size: 18px;" type = "text" name = "numcmdliv" value="<?=$_POST['numcmdliv'];?>" onchange="this.form.submit()"><?php

                        }else{?>

                          <input class="form-control" style=" font-size: 18px;" type = "text" name = "numcmdliv" placeholder="rechercher par N°" onchange="this.form.submit()"><?php
              ...
              <tbody><?php 
                ...
                foreach ($products as $key=> $product ){
                  ...
                  <tr>
                    ...
                    <td><a class="btn btn-danger" onclick="return alerteS();" href="livraisonachat.php?delete=<?=$product->id;?>&idcmd=<?=$product->idcmd;?>&idproduit=<?=$product->id_produitliv;?>&numcmd=<?=$product->numcmdliv;?>&qtite=<?=$product->quantiteliv;?>&stock=<?=$product->idstockliv;?>&livreur=<?=$product->livreur;?>&idclient=<?=$product->id_clientliv;?>&type=<?=$product->type;?>">Annuler</a></td>
                  </tr><?php 
                }?>

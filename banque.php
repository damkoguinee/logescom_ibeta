        ...
        if ($_SESSION['level']>=3) {
          ...
          if (isset($_POST['valid'])) {
            ...
            if ($compteret!='autresret') {
              ...
              $DB->insert('INSERT INTO banque (id_banque, clientbanque, origine, typeent, montant, devise, libelles, numero, lieuvente, date_versement) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', array($_POST['compteret'],"","transfert", 'transfert', -$montant, $devise, 'transfert des fonds', $numdec, $lieuventeret, $dateop));
            }

            if ($compteret!='autresdep') {

              $DB->insert('INSERT INTO banque (id_banque, clientbanque, origine, typeent, montant, devise, libelles, numero, lieuvente, date_versement) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', array($_POST['comptedep'],"","transfert", 'transfert', $montant, $devise, 'transfert des fonds', $numdec, $lieuventedep, $dateop));
            }

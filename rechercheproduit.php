...
if (isset($_GET['user'])) {
	...
	}elseif (isset($_GET['stock_general_detail'])) {

		foreach ($req as $key => $value) {?>

			<a style="font-weight: bold; color: white;" href="stock_general_detail.php?recherchgen=<?=$value->id;?>"><div><?=$value->designation;?></div></a><?php
		}
	}elseif (isset($_GET['anomalie_stock'])) {

		foreach ($req as $key => $value) {?>

			<a style="font-weight: bold; color: white;" href="anomalie_stock.php?recherchgen=<?=$value->id;?>"><div><?=$value->designation;?></div></a><?php
		}

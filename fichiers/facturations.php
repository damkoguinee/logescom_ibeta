          ...
          <table class="table table-bordered table-striped table-hover align-middle">
            ...
            <tbody><?php
              ...
              foreach ($products as $key=> $product ){
                ...
                $cumulmontantotp+=$product->Total-$product->remise+$retour;
                ...
                <tr>
                  ...
                  <td class="text-end bg-<?=$bg;?> text-<?=$textColor;?>"><?=$configuration->formatNombre($product->montantpaye); ?></td>
                  ...
                  <td class="text-end bg-<?=$bg;?> text-<?=$textColor;?>"><?=$configuration->formatNombre($product->solde_facture); ?></td>

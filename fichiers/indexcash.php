                    ...
                    <div class="container-fluid  my-2">
                        <div class="row">
                            ...
                            <div class="col-sm-7 col-md-8 m-0 p-0">
                                <form class="form" method="GET" action="indexcash.php" >
                            ...
                            <!-- <div class="col-sm-2 col-md-2 m-0 px-0">
                                <a class="btn btn-primary" href="indexcash.php?scanner">Scanner</a>
                            </div> -->
                        </div>
                    </div>
                        ...
                        if (isset($_GET['terme'])) {
                            ...
                            foreach ( $products as $product ){
                                ...
                                <div class="col pb-2 mt-2">
                                    ...
                                    <a style="text-decoration: none" href="indexcash.php?desig=<?= $product->Marque;?>&idc=<?= $product->id;?>&pv=<?= $product->prix_vente;?>">
                            ...
                            foreach ( $products as $product ){?>
                                <div class="col pb-2 mt-2">
                                    ...
                                    <a style="text-decoration: none" href="indexcash.php?logo=<?= $product->id; ?>">

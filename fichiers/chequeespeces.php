  ...
  if ($products['level']>=3) {
    ...
    if (!isset($_GET['ajout']) ) {?>  
      ...
      <table class="payement">
        ...
        <thead>
          <tr><th class="legende" colspan="12" height="30"><?="Liste des dépôts " .$datenormale ?> <a style="color:orange; font-size:30px;" href="chequeespeces.php?ajout">Enregistrer un Chèque/Espèces</a></th></tr>

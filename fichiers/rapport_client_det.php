            ...
            <table class="table table-bordered table-striped table-hover align-middle">
                ...
                <tr>
                    ...
                    <th><?php
                        ...
                        Solde <br/>
                      <label class="bg-<?=$bgSolde;?> p-1">SOLDE <?=$configuration->formatNombre($caisse->soldeRapportClient($_SESSION['date1'], $_SESSION['date2'],  $_SESSION['client_rapport'], $_SESSION['deviseselect'])['montant']);?></label>
                    </th>
                </tr>
                </thead>
                <tbody><?php
                    ...
                    foreach ($caisse->rapportClient($_SESSION['date1'], $_SESSION['date2'],  $_SESSION['client_rapport'], $_SESSION['deviseselect']) as $key=> $value ){
                        ...
                        <tr>
                            ...
                            <td class="text-end bg-<?=$bg;?>"><?=$configuration->formatNombre($montant,0,',',' ');?></td>
                            <td class="text-end bg-<?=$bgSolde;?>"><?=$configuration->formatNombre($solde);?></td>                            
                        </tr><?php 
                    } ?>   
                </tbody>
            </table>

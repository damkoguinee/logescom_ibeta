            ...
            <table class="table table-hover table-bordered table-striped table-responsive text-center">
              <thead>
                ...
                <tr>
                  ...
                  <th colspan="5">Liste des Stocks </th>
                  <th colspan="4">
              ...
              <tbody><?php
                ...
                if (empty($prodm)) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-info" href="stockmouv.php?stock=<?=$formation->nombdd;?>&idnomstock=<?=$formation->id;?>">Opération</a>
                    </td>

                    <td colspan="1">

                      <?php if ($products['statut']=='admin') {?>

    ...
    <div class="row"><?php
        ...
        <div class="col-sm-12 col-md-10"><?php 
            ...
            if (isset($_POST['validap'])) {
                ...
                $DB->insert('INSERT INTO stockmouv (idstock, origine, client, numeromouv, libelle, quantitemouv, idnomstock, coment, idpers, lieuvente_mouv, dateop) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, now())', array($idprod, "cmd", $_SESSION['idclient'], 'recepfcmd', 'entree', $qtite, $idstock1, $cmd, $_SESSION['idpseudo'], $_SESSION['lieuvente'])); ?>

  <div class="col-sm-12 col-md-2 pb-3" style="background-color: #253553;"> 
    ...
    <div class="row mt-3">
      <div class="col" ><a style="width: 100%; " class="btn btn-light text-center fw-bold" href="stock_general_detail.php">Situation/Stock</a></div>
    </div>

    <div class="row mt-3">
      <div class="col" ><a style="width: 100%; " class="btn btn-light text-center fw-bold" href="ajout.php?ajoutprod">Nouveau Produit</a></div>
    </div>
    ...
    <div class="row mt-3"><div class=" col text-center"><a style="width: 100%; " class="btn btn-light text-center fw-bold" href="anomalie_stock.php">Anomalie</a></div></div>

    <div class="row mt-3"><div class=" col text-center"><a style="width: 100%; " class="btn btn-light text-center fw-bold" href="inventaire_form.php">Inventaire</a></div></div>
    ...
    <div class="row mt-3"><div class=" col text-center"><a style="width: 100%; " class="btn btn-light text-center fw-bold" href="listeapprovisionnement.php?listeapp">Liste des Approvisionnements</a></div></div>
  </div>
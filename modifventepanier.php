<div class="tableau"><?php
	...
	if (isset($_GET['numcmdmodif']) or isset($_POST['quantity']) or isset($_POST['clientvipcash']) or isset($_POST['clientvip']) or isset($_GET['clientvip']) or isset($_GET['clientCom'])) {
			...
			<table style="margin-top: -10px;" class="payement">
					...
					<form action="payementmodif.php" method="POST" id="naissance">
						...
						<td colspan="2"><?php 
							if (isset($_GET['clientCom'])) {
								...
								<div style="background-color: red;" class="bg-danger" id="result-searchCom"></div>
						</td>
						<td>
				...
				<tbody>
					<tr><?php 
						...
						if($qtitetot!=0){?>
							<td>Nbre de Pièces: <?=$qtitetot;?></td><?php 
						}

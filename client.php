...
<div class="container-fluid">
  <div class="row"><?php
    ...
    if (isset($_SESSION['pseudo'])) {
      ...
      <form class="form" method="POST" action="client.php">

        <fieldset><legend>Ajouter un Collaborateur</legend>
          
          <div class="mb-1"><label class="form-label">Type</label>
            <select class="form-select" type="text" name="type" required="">
              <option></option>
          ...
          <div class="mb-1"><label class="form-label">Nom & Prénom*</label>
            <input class="form-control" type="text" name="client" required="">
          </div>

          <div class="mb-1"><label class="form-label">Téléphone*</label>
            <input class="form-control" type="text" name="tel" required="">
          </div>

          <div class="mb-1"><label class="form-label">E.mail</label>
            <input class="form-control" type="text" name="mail">
          </div>

          <div class="mb-1"><label class="form-label">Lieu de Facturation</label>
          ...
          <div class="mb-1"><label class="form-label">Adresse*</label>
            <input class="form-control" type="text" name="ad" required="">
          </div>

          <div class="mb-1"><label class="form-label">Solde Compte</label>
            <input class="form-control" type="text" name="scompte" value="0"> - : le client vous doit et + le contraire
          </div>
        ...
        <button class="btn btn-success" type="submit" value="Ajouter" name="valid" id="form" onclick="return alerteV();">Ajouter</button>
    ...
    if (isset($_POST['valid'])) {
      ...
      if (empty($products)) {
        ...
        <div class="alert alert-warning"><?php echo "Ce nom ou ce numéro de téléphone est déjà attribué"; ?></div><?php        
      ...
      <form id="naissance" method="POST" action="client.php" style="margin-top: 30px; width:80%;" >
        ...
        <fieldset><legend>Modifier un Collaborateur</legend>
          <ol>
            ...
            <div class="mb-1"><label class="form-label">Nom & Prénom*</label><input class="form-control" type="text" name="client" value="<?=$prodc['nom_client'];?>"><input class="form-control" type="hidden" name="id" value="<?=$prodc['id'];?>">

            <div class="mb-1"><label class="form-label">Téléphone*</label><input class="form-control" type="number"   name="tel" value="<?=$prodc['telephone'];?>">

            <div class="mb-1"><label class="form-label">E.mail</label><input class="form-control" type="text"   name="mail" value="<?=$prodc['mail'];?>">

            <div class="mb-1"><label class="form-label">Mot de Passe</label><input class="form-control" type="text"   name="mdp" value="0000" required="" placeholder="le mot de passe par defaut est 0000" >

            <div class="mb-1"><label class="form-label">Lieu de Facturation</label><select class="form-select" type="text" name="position" required="">
            ...
            <div class="mb-1"><label class="form-label">Adresse*</label><input class="form-control" type="text"   name="ad" value="<?=$prodc['adresse'];?>">

            <div class="mb-1"><label class="form-label">Solde Compte</label><input class="form-control" type="text" name="scompte" value="0"> - : pour augmenter et + pour dimunier
        ...
        <fieldset>
          ...
          <input class="form-control" type="reset" value="Annuler" name="valid" id="form" style="width:150px; cursor: pointer;"/>

          <input class="form-control" type="submit" value="Ajouter" name="validm" id="form" onclick="return alerteV();" style="margin-left: 20px; width:150px; cursor: pointer;" />
            ...
            <tr>
              <th colspan="8">
                <div class="d-flex justify-content-between ">
                  <input class="form-control" type="text" name="clientsearch" placeholder="rechercher un client" />                  
                  ...
                  <?= "Liste des Clients  " ?>
                  <a class="btn btn-warning" href="client.php?ajoutc" >Ajouter un Collaborateur</a>
                </div>
              </th>
            </tr>
          ...
          <tbody><?php
            ...
            foreach ($products as $key=> $product ){?>
              ...
              <tr>
                ...
                <td><a class="btn btn-warning" href="client.php?modifc=<?=$product->id;?>">Modifier</a></td>

                <td><?php if ($_SESSION['level']>6) {?><a onclick="return alerteS();" class="btn btn-danger" href="client.php?deletec=<?=$product->nom_client;?>">Supprimer</a><?php }?></td>
          ...
          <thead>
            ...
            <tr>
              <th class="legende" colspan="2" height="30">
                <input class="form-control" style="width:65%;" id="search-user" type="text" name="clientsearch" placeholder="rechercher un fournisseur" />
          ...
          <tbody><?php
            ...
            foreach ($products as $key=> $product ){?>
              ...
              <tr>
                ...
                <td><a href="client.php?modifc=<?=$product->id;?>"> <input class="form-control" style="width: 100%;height: 30px; font-size: 17px; background-color: orange;color: white; cursor: pointer;"  type="submit" value="Modifier"></a></td>

                <td><?php if ($_SESSION['level']>6) {?><a href="client.php?deletec=<?=$product->nom_client;?>"> <input class="form-control" style="width: 100%;height: 30px; font-size: 17px; background-color: red;color: white; cursor:pointer;"  type="submit" value="Supprimer" onclick="return alerteS();"></a><?php }?></td>
      ...
      if (isset($_GET['autres'])) {
        ...
        <table class="payement" style="margin-bottom: 30px;">
          ...
          <thead>
            ...
            <tr>
              <th class="legende" colspan="2" height="30">
                <input class="form-control" style="width:65%;" id="search-user" type="text" name="clientsearch" placeholder="rechercher un client" />
                <div style="color:white; background-color: grey; font-size: 16px;" id="result-search"></div>
              </th>
          ...
          <tbody><?php
            ...
            foreach ($products as $key=> $product ){?>
              ...
              <tr>
                ...
                <td><?php if ($_SESSION['level']>7) {?><a href="client.php?deletec=<?=$product->nom_client;?>"> <input class="form-control" style="width: 100%;height: 30px; font-size: 17px; background-color: red;color: white; cursor:pointer;"  type="submit" value="Supprimer" onclick="return alerteS();"></a><?php }?></td>

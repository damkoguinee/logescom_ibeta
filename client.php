          ...
          <tbody><?php
            ...
            foreach ($products as $key=> $product ){?>
              ...
              <tr>
                ...
                <td><?php if ($_SESSION['level']>6) {?><a href="client.php?deletec=<?=$product->nom_client;?>"> <input style="width: 100%;height: 30px; font-size: 17px; background-color: red;color: white; cursor:pointer;"  type="submit" value="Supprimer" onclick="return alerteS();"></a><?php }?></td>

...
<div class="container-fluid mt-3">
    <div class="row"><?php 
        ...
        if (isset($_POST['ajoutCom']) and !empty($_POST['montant'])) {
            ...
            $DB->insert('INSERT INTO bulletin (nom_client, origine_bull, montant, devise, libelles, numero, caissebul, lieuvente, date_versement) VALUES(?, ?, ?, ?, ?, ?, ?, ?, now())', array($clientCom, 'commission', $montantCom, 'gnf', $numc, $numcmd, $_SESSION['lieuvente'], $_SESSION['lieuvente']));

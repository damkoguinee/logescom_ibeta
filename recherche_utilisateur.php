...
if (isset($_GET['user'])) {
	...
	}elseif (isset($_GET['produit_client'])) {

		foreach ($req as $key => $value) {?>

			<a style="font-weight: bold; color: white;" href="produit_factures.php?clientsearch=<?=$value->id;?>&client"><div><?=$value->nom_client;?></div></a><?php
		}
	}elseif (isset($_GET['rapport_client'])) {

		foreach ($req as $key => $value) {?>

			<a style="font-weight: bold; color: white;" href="rapport_client.php?clientsearch=<?=$value->id;?>&client"><div><?=$value->nom_client;?></div></a><?php
		}
	}elseif (isset($_GET['rapport_client_det'])) {

		foreach ($req as $key => $value) {?>

			<a style="font-weight: bold; color: white;" href="rapport_client_det.php?clientsearch=<?=$value->id;?>&client"><div><?=$value->nom_client;?></div></a><?php
		}
	}elseif (isset($_GET['client_general'])) {

		foreach ($req as $key => $value) {?>

			<a style="font-weight: bold; color: white;" href="client_general.php?clientsearch=<?=$value->id;?>&client"><div><?=$value->nom_client;?></div></a><?php
		}
	}elseif (isset($_GET['client_mouvement_general'])) {

		foreach ($req as $key => $value) {?>

			<a style="font-weight: bold; color: white;" href="client_mouvement_general?clientsearch=<?=$value->id;?>&client"><div><?=$value->nom_client;?></div></a><?php
		}

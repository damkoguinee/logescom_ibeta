    ...
    <div class="row"><?php 
      ...
      <div class="col-sm-12 col-md-10"><?php
            ...
            foreach ($products as $product){
              ...
              <form method="Post" action="livraison.php">
                ...
                <tr>           
                  ...
                  <td style="text-align:center; color: green; font-size:12px;"><?php if ($reste==0) {echo $etat;}else{?><input class="form-control" type="float" name="qtiteliv" max="<?=$reste;?>" placeholder="inserer la qtité"><?php }?></td>
                  ...
                  <td style="text-align:center; color: green; font-size:12px;"><?php if ($reste==0) {echo $etat;}else{?><input class="form-control" type="submit" name="validl" value="Valider" onclick="return alerteL();" ><?php }?></td>
        ...
        <tfoot>
          <tr>
            <th>Totaux</th>
            <th class="text-center"><?=number_format($totqtite,0,',',' ');?></th>
            <th class="text-center"><?=number_format($totqtiteliv,0,',',' ');?></th>
            <th class="text-center"><?=number_format($totqtite-$totqtiteliv,0,',',' ');?></th>
          </tr>
        </tfoot>

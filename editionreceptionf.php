  ...
  <div class="row"><?php
    ...
    <div class="col-sm-12 col-md-10">
      ...
      if (isset($_POST['qtiteap'])) {
        ...
        $DB->insert('INSERT INTO stockmouv (idstock, origine, client, numeromouv, libelle, quantitemouv, idnomstock, coment, idpers, dateop) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, now())', array($id, "report stock", "", 'recepfinit', 'entree', $qtite, $idstock1, $bl, $_SESSION['idpseudo']));
